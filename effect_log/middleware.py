...
class HttpLoggerMiddleware:
    ...
    def _get_header(self, obj: Any, header_name: str) -> Optional[str]:
    ...
    def _get_body(self, obj: Any) -> Optional[str]:
...
class DjangoMiddleware:
    ...
    def __init__(self, get_response, middleware: HttpLoggerMiddleware):
