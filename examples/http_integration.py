...
def fastapi_example():
    ...
    try:
        ...
        ).with_context(service="fastapi-api", version="2.0.0")
        ...
        async def logging_middleware(request: Request, call_next):
            ...
            try:
                ...
                # Log exception
                request_logger.error("Request failed", error=str(e), exception=type(e).__name__)
                raise
...
def custom_middleware_example():
    ...
    middleware = CustomFrameworkMiddleware(logger)
